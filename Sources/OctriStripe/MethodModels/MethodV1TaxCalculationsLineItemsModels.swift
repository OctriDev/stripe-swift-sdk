...
// Canonical v1TaxCalculationsLineItems operation model declarations
public struct GetTaxCalculationsCalculationLineItemsResponse: Codable {
    ...
    /// `list`.
    public var object: GetTaxCalculationsCalculationLineItemsResponseObject
...
public extension GetTaxCalculationsCalculationLineItemsResponse {
...
public extension GetTaxCalculationsCalculationLineItemsResponse {
    public init(data: [TaxCalculationLineItem], hasMore: Bool, object: GetTaxCalculationsCalculationLineItemsResponseObject, url: String) throws {
