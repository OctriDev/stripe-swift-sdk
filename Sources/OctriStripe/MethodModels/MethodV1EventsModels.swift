...
// Canonical v1Events operation model declarations
public enum GetEventsParameter {
    case getEventsParameterVariant0(GetEventsParameterVariant0)
    case intValue(Int)
}

extension GetEventsParameter: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for GetEventsParameter")
    }

    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        if let value = try? container.decode(GetEventsParameterVariant0.self) { return .getEventsParameterVariant0(value) }
    ...
    private func encodeGroup1(to encoder: Encoder) throws -> Bool {
        ...
        switch self {
        case let .getEventsParameterVariant0(value): try container.encode(value); return true
...
public struct GetEventsResponse: Codable {
    ...
    /// `list`.
    public var object: GetEventsResponseObject
...
public extension GetEventsResponse {
    public init(from decoder: Decoder) throws {
        ...
        self.url = try container.sdkDecodeRequired(.url)
            ...
            try sdkValidatePattern("url", self.url, sdkPattern66b29ab6ffc2)
    }
}

public extension GetEventsResponse {
    public init(data: [Event], hasMore: Bool, object: GetEventsResponseObject, url: String) throws {
...
public struct GetEventsParameterVariant0: Codable {
    public var gt: Int?
    public var gte: Int?
    public var lt: Int?
    public var lte: Int?
...
public extension GetEventsParameterVariant0 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
