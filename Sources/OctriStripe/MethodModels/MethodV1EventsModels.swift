...
extension GetEventsParameter: Codable {
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.dataCorruptedError(
            in: container,
            debugDescription: "No variant matched for GetEventsParameter"
        )
    }

    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        if let value = try? container
            .decode(GetEventsParameterVariant0.self) {
            return .getEventsParameterVariant0(value)
        }
...
public extension GetEventsResponse {
    init(from decoder: Decoder) throws {
        ...
        try sdkValidatePattern("url", url, sdkPattern66b29ab6ffc2)
    }
}

public extension GetEventsResponse {
    init(data: [Event], hasMore: Bool, object: GetEventsResponseObject, url: String) throws {
