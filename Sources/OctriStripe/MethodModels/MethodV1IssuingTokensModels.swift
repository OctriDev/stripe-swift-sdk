...
// Canonical v1IssuingTokens operation model declarations
public struct GetIssuingTokensParameterVariant0: Codable {
    public var gt: Int?
    public var gte: Int?
    public var lt: Int?
    public var lte: Int?
...
public extension GetIssuingTokensParameterVariant0 {
...
public struct GetIssuingTokensResponse: Codable {
    ...
    /// `list`.
    public var object: GetIssuingTokensResponseObject
...
public extension GetIssuingTokensResponse {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension GetIssuingTokensResponse {
    public init(data: [IssuingToken], hasMore: Bool, object: GetIssuingTokensResponseObject, url: String) throws {
...
public enum GetIssuingTokensParameter {
    case getIssuingTokensParameterVariant0(GetIssuingTokensParameterVariant0)
    case intValue(Int)
}

extension GetIssuingTokensParameter: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for GetIssuingTokensParameter")
    }

    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        if let value = try? container.decode(GetIssuingTokensParameterVariant0.self) { return .getIssuingTokensParameterVariant0(value) }
    ...
    private func encodeGroup1(to encoder: Encoder) throws -> Bool {
        ...
        switch self {
        case let .getIssuingTokensParameterVariant0(value): try container.encode(value); return true
