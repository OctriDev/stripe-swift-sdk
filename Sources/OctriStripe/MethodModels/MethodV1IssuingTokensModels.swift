...
public extension GetIssuingTokensResponse {
    init(data: [IssuingToken], hasMore: Bool, object: GetIssuingTokensResponseObject, url: String) throws {
...
extension GetIssuingTokensParameter: Codable {
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.dataCorruptedError(
            in: container,
            debugDescription: "No variant matched for GetIssuingTokensParameter"
        )
    }

    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        if let value = try? container
            .decode(GetIssuingTokensParameterVariant0.self) {
            return .getIssuingTokensParameterVariant0(value)
        }
