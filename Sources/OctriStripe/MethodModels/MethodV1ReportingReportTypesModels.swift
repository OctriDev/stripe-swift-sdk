...
// Canonical v1ReportingReportTypes operation model declarations
public struct GetReportingReportTypesResponse: Codable {
    ...
    /// `list`.
    public var object: GetReportingReportTypesResponseObject
...
public extension GetReportingReportTypesResponse {
...
public extension GetReportingReportTypesResponse {
    public init(data: [ReportingReportType], hasMore: Bool, object: GetReportingReportTypesResponseObject, url: String) throws {
