...
extension PostSubscriptionsSubscriptionExposedIdRequestBodyPaymentSettiXbda25513d6 {
...
extension PostSubscriptionsSubscriptionExposedIdRequestBodyAddInvoiceItemsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
