...
public extension GetApplicationFeesIdRefundsResponse {
    init(data: [FeeRefund], hasMore: Bool, object: GetApplicationFeesIdRefundsResponseObject, url: String) throws {
...
extension PostApplicationFeesFeeRefundsIdRequestBodyMetadata: Codable {
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.dataCorruptedError(
            in: container,
            debugDescription: "No variant matched for PostApplicationFeesFeeRefundsIdRequestBodyMetadata"
        )
    }
