...
// Canonical v1ApplicationFeesRefunds operation model declarations
public struct GetApplicationFeesIdRefundsResponse: Codable {
    ...
    /// `list`.
    public var object: GetApplicationFeesIdRefundsResponseObject
...
public extension GetApplicationFeesIdRefundsResponse {
...
public extension GetApplicationFeesIdRefundsResponse {
    public init(data: [FeeRefund], hasMore: Bool, object: GetApplicationFeesIdRefundsResponseObject, url: String) throws {
...
public enum PostApplicationFeesFeeRefundsIdRequestBodyMetadata {
    case dictionary([String: String])
    case stringValue(String)
}

extension PostApplicationFeesFeeRefundsIdRequestBodyMetadata: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for PostApplicationFeesFeeRefundsIdRequestBodyMetadata")
    }
