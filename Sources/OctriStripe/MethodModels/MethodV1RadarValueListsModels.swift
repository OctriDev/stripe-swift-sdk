...
extension GetRadarValueListsParameter: Codable {
    ...
    private func encodeGroup1(to encoder: Encoder) throws -> Bool {
        ...
        switch self {
        case let .getRadarValueListsParameterVariant0(value): try container.encode(value); return true
...
public struct GetRadarValueListsResponse: Codable {
    ...
    /// `list`.
    public var object: GetRadarValueListsResponseObject
