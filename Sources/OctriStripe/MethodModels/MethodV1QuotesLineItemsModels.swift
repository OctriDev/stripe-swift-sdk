...
// Canonical v1QuotesLineItems operation model declarations
public struct GetQuotesQuoteLineItemsResponse: Codable {
    ...
    /// `list`.
    public var object: GetQuotesQuoteLineItemsResponseObject
...
public extension GetQuotesQuoteLineItemsResponse {
...
public extension GetQuotesQuoteLineItemsResponse {
    public init(data: [Item], hasMore: Bool, object: GetQuotesQuoteLineItemsResponseObject, url: String) throws {
