...
extension PostIssuingCardsCardRequestBodyShipping {
...
extension PostIssuingCardsRequestBodyShippingCustoms {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostIssuingCardsRequestBodyPin {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostIssuingCardsRequestBodyShippingAddress {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostIssuingCardsRequestBodyLifecycleControlsCancelAfter {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostIssuingCardsRequestBodySpendingControlsSpendingLimitsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostIssuingCardsCardRequestBodyPin {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.encryptedNumber = try container.sdkDecodeIfPresent(.encryptedNumber)
        if let value = self.encryptedNumber {
...
extension PostIssuingCardsRequestBodyShipping {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.address) else {
            throw SdkValidationError(field: "address", code: "required", message: "Validation failed for 'address': value is required")
...
extension PostIssuingCardsCardRequestBodyShippingAddress {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.city) else {
            throw SdkValidationError(field: "city", code: "required", message: "Validation failed for 'city': value is required")
