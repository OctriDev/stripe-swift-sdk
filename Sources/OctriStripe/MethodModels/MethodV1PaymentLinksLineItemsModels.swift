...
// Canonical v1PaymentLinksLineItems operation model declarations
public struct GetPaymentLinksPaymentLinkLineItemsResponse: Codable {
    ...
    /// `list`.
    public var object: GetPaymentLinksPaymentLinkLineItemsResponseObject
...
public extension GetPaymentLinksPaymentLinkLineItemsResponse {
...
public extension GetPaymentLinksPaymentLinkLineItemsResponse {
    public init(data: [Item], hasMore: Bool, object: GetPaymentLinksPaymentLinkLineItemsResponseObject, url: String) throws {
