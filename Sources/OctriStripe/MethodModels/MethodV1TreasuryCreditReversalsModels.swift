...
// Canonical v1TreasuryCreditReversals operation model declarations
public struct GetTreasuryCreditReversalsResponse: Codable {
    /// Details about each object.
    public var data: [TreasuryCreditReversal]
    ...
    /// `list`.
    public var object: GetTreasuryCreditReversalsResponseObject
...
public extension GetTreasuryCreditReversalsResponse {
...
public extension GetTreasuryCreditReversalsResponse {
    public init(data: [TreasuryCreditReversal], hasMore: Bool, object: GetTreasuryCreditReversalsResponseObject, url: String) throws {
