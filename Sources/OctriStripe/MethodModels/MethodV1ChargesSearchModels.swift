...
// Canonical v1ChargesSearch operation model declarations
public struct GetChargesSearchResponse: Codable {
    public var data: [Charge]
    public var hasMore: Bool
    /// String representing the object's type. Objects of the same type share the same value.
    public var object: GetChargesSearchResponseObject
...
public extension GetChargesSearchResponse {
...
public extension GetChargesSearchResponse {
    public init(data: [Charge], hasMore: Bool, object: GetChargesSearchResponseObject, url: String, nextPage: String? = nil, totalCount: Int? = nil) throws {
