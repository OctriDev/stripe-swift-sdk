...
// Canonical v1FinancialConnectionsAccounts operation model declarations
public struct GetFinancialConnectionsAccountsParameter: Codable {
...
public extension GetFinancialConnectionsAccountsParameter {
...
public struct GetFinancialConnectionsAccountsResponse: Codable {
    ...
    /// `list`.
    public var object: GetFinancialConnectionsAccountsResponseObject
...
public extension GetFinancialConnectionsAccountsResponse {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension GetFinancialConnectionsAccountsResponse {
    public init(data: [FinancialConnectionsAccount], hasMore: Bool, object: GetFinancialConnectionsAccountsResponseObject, url: String) throws {
