...
// Canonical v1QuotesComputedUpfrontLineItems operation model declarations
public struct GetQuotesQuoteComputedUpfrontLineItemsResponse: Codable {
    ...
    /// `list`.
    public var object: GetQuotesQuoteComputedUpfrontLineItemsResponseObject
...
public extension GetQuotesQuoteComputedUpfrontLineItemsResponse {
...
public extension GetQuotesQuoteComputedUpfrontLineItemsResponse {
    public init(data: [Item], hasMore: Bool, object: GetQuotesQuoteComputedUpfrontLineItemsResponseObject, url: String) throws {
