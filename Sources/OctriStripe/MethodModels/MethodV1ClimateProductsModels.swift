...
/// Canonical v1ClimateProducts operation model declarations
public struct GetClimateProductsResponse: Codable {
    ...
    /// `list`.
    public var object: GetClimateProductsResponseObject
...
public extension GetClimateProductsResponse {
    init(from decoder: Decoder) throws {
        ...
        try sdkValidatePattern("url", url, sdkPattern1d83648e9968)
    }
}

public extension GetClimateProductsResponse {
    init(data: [ClimateProduct], hasMore: Bool, object: GetClimateProductsResponseObject, url: String) throws {
        (self.data, self.hasMore) = (data, hasMore)
        (self.object, self.url) = (object, url)
        try validateLength("url", self.url, min: nil, max: 5000)
        try sdkValidatePattern("url", self.url, sdkPattern1d83648e9968)
    }
}
