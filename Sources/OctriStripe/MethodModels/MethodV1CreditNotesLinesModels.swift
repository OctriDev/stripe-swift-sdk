...
// Canonical v1CreditNotesLines operation model declarations
public struct GetCreditNotesCreditNoteLinesResponse: Codable {
    ...
    /// `list`.
    public var object: GetCreditNotesCreditNoteLinesResponseObject
...
public extension GetCreditNotesCreditNoteLinesResponse {
...
public extension GetCreditNotesCreditNoteLinesResponse {
    public init(data: [CreditNoteLineItem], hasMore: Bool, object: GetCreditNotesCreditNoteLinesResponseObject, url: String) throws {
