...
extension PostPaymentIntentsRequestBodyPaymentMethodData {
...
extension PostPaymentIntentsRequestBodyPaymentMethodDataUsBankAccount {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostPaymentIntentsIntentRequestBodyPaymentMethodOptionsSepaDeXbe8714b0aa {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostPaymentIntentsRequestBodyPaymentMethodOptionsKlarnaVariant0OnDemand {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
