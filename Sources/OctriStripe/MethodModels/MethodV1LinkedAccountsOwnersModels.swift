...
// Canonical v1LinkedAccountsOwners operation model declarations
public struct GetLinkedAccountsAccountOwnersResponse: Codable {
    ...
    /// `list`.
    public var object: GetLinkedAccountsAccountOwnersResponseObject
...
public extension GetLinkedAccountsAccountOwnersResponse {
...
public extension GetLinkedAccountsAccountOwnersResponse {
    public init(data: [FinancialConnectionsAccountOwner], hasMore: Bool, object: GetLinkedAccountsAccountOwnersResponseObject, url: String) throws {
