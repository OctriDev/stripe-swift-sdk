...
// Canonical v1InvoiceRenderingTemplates operation model declarations
public struct GetInvoiceRenderingTemplatesResponse: Codable {
    ...
    /// `list`.
    public var object: GetInvoiceRenderingTemplatesResponseObject
...
public extension GetInvoiceRenderingTemplatesResponse {
...
public extension GetInvoiceRenderingTemplatesResponse {
    public init(data: [InvoiceRenderingTemplate], hasMore: Bool, object: GetInvoiceRenderingTemplatesResponseObject, url: String) throws {
