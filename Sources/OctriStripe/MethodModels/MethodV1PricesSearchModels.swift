...
// Canonical v1PricesSearch operation model declarations
public struct GetPricesSearchResponse: Codable {
    public var data: [Price]
    public var hasMore: Bool
    /// String representing the object's type. Objects of the same type share the same value.
    public var object: GetPricesSearchResponseObject
...
public extension GetPricesSearchResponse {
...
public extension GetPricesSearchResponse {
    public init(data: [Price], hasMore: Bool, object: GetPricesSearchResponseObject, url: String, nextPage: String? = nil, totalCount: Int? = nil) throws {
