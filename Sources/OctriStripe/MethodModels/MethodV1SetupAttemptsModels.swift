...
public extension GetSetupAttemptsResponse {
    init(from decoder: Decoder) throws {
        ...
        try sdkValidatePattern("url", url, sdkPattern95989920f999)
    }
}

public extension GetSetupAttemptsResponse {
    init(data: [SetupAttempt], hasMore: Bool, object: GetSetupAttemptsResponseObject, url: String) throws {
...
extension GetSetupAttemptsParameter: Codable {
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.dataCorruptedError(
            in: container,
            debugDescription: "No variant matched for GetSetupAttemptsParameter"
        )
    }

    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        if let value = try? container
            .decode(GetSetupAttemptsParameterVariant0.self) {
            return .getSetupAttemptsParameterVariant0(value)
        }
