...
// Canonical v1SetupAttempts operation model declarations
public struct GetSetupAttemptsResponse: Codable {
    ...
    /// `list`.
    public var object: GetSetupAttemptsResponseObject
...
public extension GetSetupAttemptsResponse {
    public init(from decoder: Decoder) throws {
        ...
        self.url = try container.sdkDecodeRequired(.url)
            ...
            try sdkValidatePattern("url", self.url, sdkPattern95989920f999)
    }
}

public extension GetSetupAttemptsResponse {
    public init(data: [SetupAttempt], hasMore: Bool, object: GetSetupAttemptsResponseObject, url: String) throws {
...
public struct GetSetupAttemptsParameterVariant0: Codable {
    public var gt: Int?
    public var gte: Int?
    public var lt: Int?
    public var lte: Int?
...
public extension GetSetupAttemptsParameterVariant0 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum GetSetupAttemptsParameter {
    case getSetupAttemptsParameterVariant0(GetSetupAttemptsParameterVariant0)
    case intValue(Int)
}

extension GetSetupAttemptsParameter: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for GetSetupAttemptsParameter")
    }

    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        if let value = try? container.decode(GetSetupAttemptsParameterVariant0.self) { return .getSetupAttemptsParameterVariant0(value) }
    ...
    private func encodeGroup1(to encoder: Encoder) throws -> Bool {
        ...
        switch self {
        case let .getSetupAttemptsParameterVariant0(value): try container.encode(value); return true
