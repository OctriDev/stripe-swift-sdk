...
// Canonical v1PaymentMethodDomains operation model declarations
public struct GetPaymentMethodDomainsResponse: Codable {
    ...
    /// `list`.
    public var object: GetPaymentMethodDomainsResponseObject
...
public extension GetPaymentMethodDomainsResponse {
    public init(from decoder: Decoder) throws {
        ...
        self.url = try container.sdkDecodeRequired(.url)
            ...
            try sdkValidatePattern("url", self.url, sdkPattern094f241063e0)
    }
}

public extension GetPaymentMethodDomainsResponse {
    public init(data: [PaymentMethodDomain], hasMore: Bool, object: GetPaymentMethodDomainsResponseObject, url: String) throws {
