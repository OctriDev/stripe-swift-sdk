...
extension PostPricesRequestBodyTransformQuantity {
...
extension PostPricesRequestBodyCurrencyOptionsValue {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostPricesPriceRequestBodyCurrencyOptionsVariant0ValueTiersItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostPricesRequestBodyProductData {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostPricesRequestBodyTiersItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.upTo) else {
            throw SdkValidationError(field: "up_to", code: "required", message: "Validation failed for 'up_to': value is required")
