...
extension GetCreditNotesPreviewParameterItemXb900464a {
    public init(from decoder: Decoder) throws {
...
extension GetCreditNotesPreviewParameterItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension GetCreditNotesPreviewParameterItemTaxAmountsVariant0Item {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension GetCreditNotesPreviewParameterItemPaymentRecordRefund {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension GetCreditNotesPreviewParameterXa8f02801 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
