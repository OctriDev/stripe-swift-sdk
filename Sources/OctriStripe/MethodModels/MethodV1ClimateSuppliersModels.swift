...
/// Canonical v1ClimateSuppliers operation model declarations
public struct GetClimateSuppliersResponse: Codable {
    public var data: [ClimateSupplier]
    ...
    /// `list`.
    public var object: GetClimateSuppliersResponseObject
...
public extension GetClimateSuppliersResponse {
    init(from decoder: Decoder) throws {
        ...
        try sdkValidatePattern("url", url, sdkPattern4765f244b5be)
    }
}

public extension GetClimateSuppliersResponse {
    init(data: [ClimateSupplier], hasMore: Bool, object: GetClimateSuppliersResponseObject, url: String) throws {
        (self.data, self.hasMore) = (data, hasMore)
        (self.object, self.url) = (object, url)
        try validateLength("url", self.url, min: nil, max: 5000)
        try sdkValidatePattern("url", self.url, sdkPattern4765f244b5be)
    }
}
