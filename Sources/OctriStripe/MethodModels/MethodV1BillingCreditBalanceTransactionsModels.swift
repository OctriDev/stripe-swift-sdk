...
// Canonical v1BillingCreditBalanceTransactions operation model declarations
public struct GetBillingCreditBalanceTransactionsResponse: Codable {
    public var data: [BillingCreditBalanceTransaction]
    ...
    /// `list`.
    public var object: GetBillingCreditBalanceTransactionsResponseObject
...
public extension GetBillingCreditBalanceTransactionsResponse {
...
public extension GetBillingCreditBalanceTransactionsResponse {
    public init(data: [BillingCreditBalanceTransaction], hasMore: Bool, object: GetBillingCreditBalanceTransactionsResponseObject, url: String) throws {
