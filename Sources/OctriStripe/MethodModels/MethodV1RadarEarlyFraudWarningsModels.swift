...
public extension GetRadarEarlyFraudWarningsResponse {
    public init(data: [RadarEarlyFraudWarning], hasMore: Bool, object: GetRadarEarlyFraudWarningsResponseObject, url: String) throws {
...
extension GetRadarEarlyFraudWarningsParameter: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for GetRadarEarlyFraudWarningsParameter")
    }
