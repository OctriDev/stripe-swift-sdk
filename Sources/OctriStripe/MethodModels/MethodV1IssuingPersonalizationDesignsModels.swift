...
extension GetIssuingPersonalizationDesignsParameter {
...
extension PostIssuingPersonalizationDesignsPersonalizationDesignRequestX19f2a06934 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension GetIssuingPersonalizationDesignsResponse {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostIssuingPersonalizationDesignsRequestBodyPreferences {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostIssuingPersonalizationDesignsPersonalizationDesignRequestX99f5723ca1 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.isDefault) else {
            throw SdkValidationError(field: "is_default", code: "required", message: "Validation failed for 'is_default': value is required")
...
extension PostIssuingPersonalizationDesignsRequestBodyCarrierText {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.footerBody = try container.sdkDecodeIfPresent(.footerBody)
        self.footerTitle = try container.sdkDecodeIfPresent(.footerTitle)
