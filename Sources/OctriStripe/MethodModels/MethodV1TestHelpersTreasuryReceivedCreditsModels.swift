...
extension PostTestHelpersTreasuryReceivedCreditsRequestBodyInitiatingPaX0322fc1d60 {
...
extension PostTestHelpersTreasuryReceivedCreditsRequestBodyInitiatingPaXdf8fbf265c {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
