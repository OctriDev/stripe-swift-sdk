...
// Canonical v1ApplicationFees operation model declarations
public enum GetApplicationFeesParameter {
    case getApplicationFeesParameterVariant0(GetApplicationFeesParameterVariant0)
    case intValue(Int)
}

extension GetApplicationFeesParameter: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for GetApplicationFeesParameter")
    }

    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        if let value = try? container.decode(
            GetApplicationFeesParameterVariant0.self
        ) {
            return             .getApplicationFeesParameterVariant0(value)
        }
    ...
    private func encodeGroup1(to encoder: Encoder) throws -> Bool {
        ...
        switch self {
        case let .getApplicationFeesParameterVariant0(value): try container.encode(value); return true
...
public struct GetApplicationFeesParameterVariant0: Codable {
    public var gt: Int?
    public var gte: Int?
    public var lt: Int?
    public var lte: Int?
...
public extension GetApplicationFeesParameterVariant0 {
    public init(from decoder: Decoder) throws {
...
public struct GetApplicationFeesResponse: Codable {
    ...
    /// `list`.
    public var object: GetApplicationFeesResponseObject
...
public extension GetApplicationFeesResponse {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        ...
        self.url = try container.sdkDecodeRequired(.url)
            ...
            try sdkValidatePattern("url", self.url, sdkPatternf00a9f214a0b)
    }
}

public extension GetApplicationFeesResponse {
    public init(data: [ApplicationFee], hasMore: Bool, object: GetApplicationFeesResponseObject, url: String) throws {
