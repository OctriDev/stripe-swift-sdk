...
// Canonical v1CheckoutSessionsLineItems operation model declarations
public struct GetCheckoutSessionsSessionLineItemsResponse: Codable {
    ...
    /// `list`.
    public var object: GetCheckoutSessionsSessionLineItemsResponseObject
...
public extension GetCheckoutSessionsSessionLineItemsResponse {
...
public extension GetCheckoutSessionsSessionLineItemsResponse {
    public init(data: [Item], hasMore: Bool, object: GetCheckoutSessionsSessionLineItemsResponseObject, url: String) throws {
