...
// Canonical v1TestHelpersTestClocks operation model declarations
public struct GetTestHelpersTestClocksResponse: Codable {
    public var data: [TestHelpersTestClock]
    ...
    /// `list`.
    public var object: GetTestHelpersTestClocksResponseObject
...
public extension GetTestHelpersTestClocksResponse {
    public init(from decoder: Decoder) throws {
        ...
        self.url = try container.sdkDecodeRequired(.url)
            ...
            try sdkValidatePattern("url", self.url, sdkPatternf9979689bb99)
    }
}

public extension GetTestHelpersTestClocksResponse {
    public init(data: [TestHelpersTestClock], hasMore: Bool, object: GetTestHelpersTestClocksResponseObject, url: String) throws {
