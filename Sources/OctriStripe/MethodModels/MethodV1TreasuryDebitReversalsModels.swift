...
// Canonical v1TreasuryDebitReversals operation model declarations
public struct GetTreasuryDebitReversalsResponse: Codable {
    /// Details about each object.
    public var data: [TreasuryDebitReversal]
    ...
    /// `list`.
    public var object: GetTreasuryDebitReversalsResponseObject
...
public extension GetTreasuryDebitReversalsResponse {
...
public extension GetTreasuryDebitReversalsResponse {
    public init(data: [TreasuryDebitReversal], hasMore: Bool, object: GetTreasuryDebitReversalsResponseObject, url: String) throws {
