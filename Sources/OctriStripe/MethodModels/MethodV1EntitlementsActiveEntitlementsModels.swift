...
// Canonical v1EntitlementsActiveEntitlements operation model declarations
public struct GetEntitlementsActiveEntitlementsResponse: Codable {
    public var data: [EntitlementsActiveEntitlement]
    ...
    /// `list`.
    public var object: GetEntitlementsActiveEntitlementsResponseObject
...
public extension GetEntitlementsActiveEntitlementsResponse {
...
public extension GetEntitlementsActiveEntitlementsResponse {
    public init(data: [EntitlementsActiveEntitlement], hasMore: Bool, object: GetEntitlementsActiveEntitlementsResponseObject, url: String) throws {
