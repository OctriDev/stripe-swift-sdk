...
// Canonical v1CustomersPaymentMethods operation model declarations
public struct GetCustomersCustomerPaymentMethodsResponse: Codable {
    ...
    /// `list`.
    public var object: GetCustomersCustomerPaymentMethodsResponseObject
...
public extension GetCustomersCustomerPaymentMethodsResponse {
...
public extension GetCustomersCustomerPaymentMethodsResponse {
    public init(data: [PaymentMethod], hasMore: Bool, object: GetCustomersCustomerPaymentMethodsResponseObject, url: String) throws {
