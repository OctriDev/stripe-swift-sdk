...
// Canonical v1PaymentAttemptRecords operation model declarations
/// A list of PaymentAttemptRecords.
public struct GetPaymentAttemptRecordsResponse: Codable {
    ...
    /// `list`.
    public var object: GetPaymentAttemptRecordsResponseObject
...
public extension GetPaymentAttemptRecordsResponse {
...
public extension GetPaymentAttemptRecordsResponse {
    public init(data: [PaymentAttemptRecord], hasMore: Bool, object: GetPaymentAttemptRecordsResponseObject, url: String) throws {
