...
// Canonical v1TreasuryReceivedDebits operation model declarations
public struct GetTreasuryReceivedDebitsResponse: Codable {
    /// Details about each object.
    public var data: [TreasuryReceivedDebit]
    ...
    /// `list`.
    public var object: GetTreasuryReceivedDebitsResponseObject
...
public extension GetTreasuryReceivedDebitsResponse {
...
public extension GetTreasuryReceivedDebitsResponse {
    public init(data: [TreasuryReceivedDebit], hasMore: Bool, object: GetTreasuryReceivedDebitsResponseObject, url: String) throws {
