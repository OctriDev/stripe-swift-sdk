...
// Canonical v1InvoicesSearch operation model declarations
public struct GetInvoicesSearchResponse: Codable {
    public var data: [Invoice]
    public var hasMore: Bool
    /// String representing the object's type. Objects of the same type share the same value.
    public var object: GetInvoicesSearchResponseObject
...
public extension GetInvoicesSearchResponse {
...
public extension GetInvoicesSearchResponse {
    public init(data: [Invoice], hasMore: Bool, object: GetInvoicesSearchResponseObject, url: String, nextPage: String? = nil, totalCount: Int? = nil) throws {
