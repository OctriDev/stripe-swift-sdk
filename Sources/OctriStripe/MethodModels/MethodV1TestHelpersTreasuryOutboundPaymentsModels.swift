...
extension PostTestHelpersTreasuryOutboundPaymentsIdRequestBodyTrackingDX6def454484 {
...
extension PostTestHelpersTreasuryOutboundPaymentsIdRequestBodyTrackingDetailsAch {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostTestHelpersTreasuryOutboundPaymentsIdRequestBodyTrackingDetails {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
