...
public extension GetInvoicePaymentsResponse {
    init(data: [InvoicePayment], hasMore: Bool, object: GetInvoicePaymentsResponseObject, url: String) throws {
...
public extension GetInvoicePaymentsParameterX26920026 {
    init(type: GetInvoicePaymentsParameterType, paymentIntent: String? = nil, paymentRecord: String? = nil) throws {
...
extension GetInvoicePaymentsParameter: Codable {
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.dataCorruptedError(
            in: container,
            debugDescription: "No variant matched for GetInvoicePaymentsParameter"
        )
    }
