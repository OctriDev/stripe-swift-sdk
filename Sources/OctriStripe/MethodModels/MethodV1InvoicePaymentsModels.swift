...
// Canonical v1InvoicePayments operation model declarations
public struct GetInvoicePaymentsResponse: Codable {
    ...
    /// `list`.
    public var object: GetInvoicePaymentsResponseObject
...
public extension GetInvoicePaymentsResponse {
...
public extension GetInvoicePaymentsResponse {
    public init(data: [InvoicePayment], hasMore: Bool, object: GetInvoicePaymentsResponseObject, url: String) throws {
...
public struct GetInvoicePaymentsParameterX26920026: Codable {
    public var type: GetInvoicePaymentsParameterType
...
public extension GetInvoicePaymentsParameterX26920026 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension GetInvoicePaymentsParameterX26920026 {
    public init(type: GetInvoicePaymentsParameterType, paymentIntent: String? = nil, paymentRecord: String? = nil) throws {
        (self.type, self.paymentIntent) = (type, paymentIntent)
...
public struct GetInvoicePaymentsParameterVariant0: Codable {
    public var gt: Int?
    public var gte: Int?
    public var lt: Int?
    public var lte: Int?
...
public extension GetInvoicePaymentsParameterVariant0 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum GetInvoicePaymentsParameter {
    case getInvoicePaymentsParameterVariant0(GetInvoicePaymentsParameterVariant0)
    case intValue(Int)
}

extension GetInvoicePaymentsParameter: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for GetInvoicePaymentsParameter")
    }

    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        if let value = try? container.decode(
            GetInvoicePaymentsParameterVariant0.self
        ) {
            return             .getInvoicePaymentsParameterVariant0(value)
        }
    ...
    private func encodeGroup1(to encoder: Encoder) throws -> Bool {
        ...
        switch self {
        case let .getInvoicePaymentsParameterVariant0(value): try container.encode(value); return true
