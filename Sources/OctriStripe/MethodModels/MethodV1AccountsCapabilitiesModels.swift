...
// Canonical v1AccountsCapabilities operation model declarations
public struct GetAccountsAccountCapabilitiesResponse: Codable {
    ...
    /// `list`.
    public var object: GetAccountsAccountCapabilitiesResponseObject
...
public extension GetAccountsAccountCapabilitiesResponse {
...
public extension GetAccountsAccountCapabilitiesResponse {
    public init(data: [Capability], hasMore: Bool, object: GetAccountsAccountCapabilitiesResponseObject, url: String) throws {
