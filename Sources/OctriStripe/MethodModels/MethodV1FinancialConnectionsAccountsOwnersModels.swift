...
// Canonical v1FinancialConnectionsAccountsOwners operation model declarations
public struct GetFinancialConnectionsAccountsAccountOwnersResponse: Codable {
    ...
    /// `list`.
    public var object: GetFinancialConnectionsAccountsAccountOwnersResponseObject
...
public extension GetFinancialConnectionsAccountsAccountOwnersResponse {
...
public extension GetFinancialConnectionsAccountsAccountOwnersResponse {
    public init(data: [FinancialConnectionsAccountOwner], hasMore: Bool, object: GetFinancialConnectionsAccountsAccountOwnersResponseObject, url: String) throws {
