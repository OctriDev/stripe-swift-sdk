...
extension PostCreditNotesRequestBodyRefundsItem {
...
extension PostCreditNotesRequestBodyLinesItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension GetCreditNotesParameterVariant0 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostCreditNotesRequestBodyShippingCost {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostCreditNotesRequestBodyLinesItemTaxAmountsVariant0Item {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension GetCreditNotesResponse {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostCreditNotesRequestBodyRefundsItemPaymentRecordRefund {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
