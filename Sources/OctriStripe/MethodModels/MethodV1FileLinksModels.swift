...
public enum PostFileLinksLinkRequestBodyExpiresAt {
...
public enum GetFileLinksParameter {
    case getFileLinksParameterVariant0(GetFileLinksParameterVariant0)
    case intValue(Int)
}
...
extension GetFileLinksParameter: Codable {
    ...
    private func encodeGroup1(to encoder: Encoder) throws -> Bool {
        var container = encoder.singleValueContainer()
        switch self {
        case let .getFileLinksParameterVariant0(value): try container.encode(value); return true
        case let .intValue(value): try container.encode(value); return true
        }
    }
...
public struct GetFileLinksResponse: Codable {
    ...
    /// `list`.
    public var object: GetFileLinksResponseObject
...
public enum PostFileLinksRequestBodyMetadata {
