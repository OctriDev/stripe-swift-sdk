...
extension PostRadarPaymentEvaluationsRequestBodyPaymentDetailsShippingDX529169394f {
...
extension PostRadarPaymentEvaluationsRequestBodyPaymentDetails {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostRadarPaymentEvaluationsRequestBodyPaymentDetailsPaymentMethodDetails {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostRadarPaymentEvaluationsRequestBodyPaymentDetailsMoneyMoveXe573ad4f36 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostRadarPaymentEvaluationsRequestBodyCustomerDetails {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostRadarPaymentEvaluationsRequestBodyClientDeviceMetadataDetails {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostRadarPaymentEvaluationsRequestBodyPaymentDetailsShippingDetails {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostRadarPaymentEvaluationsRequestBodyPaymentDetailsPaymentMeXf5c004722a {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.address = try container.sdkDecodeIfPresent(.address)
        self.email = try container.sdkDecodeIfPresent(.email)
...
extension PostRadarPaymentEvaluationsRequestBodyPaymentDetailsMoneyMovementDetails {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension PostRadarPaymentEvaluationsRequestBodyPaymentDetailsPaymentMeX87da9533a8 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.city = try container.sdkDecodeIfPresent(.city)
        self.country = try container.sdkDecodeIfPresent(.country)
