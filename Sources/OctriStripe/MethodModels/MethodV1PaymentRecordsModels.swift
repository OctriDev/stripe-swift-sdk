...
// Canonical v1PaymentRecords operation model declarations
/// A list of PaymentRecords.
public struct GetPaymentRecordsResponse: Codable {
    ...
    /// `list`.
    public var object: GetPaymentRecordsResponseObject
...
public extension GetPaymentRecordsResponse {
...
public extension GetPaymentRecordsResponse {
    public init(data: [PaymentRecord], hasMore: Bool, object: GetPaymentRecordsResponseObject, url: String) throws {
