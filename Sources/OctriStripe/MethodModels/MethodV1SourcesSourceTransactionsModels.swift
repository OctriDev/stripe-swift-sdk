...
// Canonical v1SourcesSourceTransactions operation model declarations
public struct GetSourcesSourceSourceTransactionsResponse: Codable {
    ...
    /// `list`.
    public var object: GetSourcesSourceSourceTransactionsResponseObject
...
public extension GetSourcesSourceSourceTransactionsResponse {
...
public extension GetSourcesSourceSourceTransactionsResponse {
    public init(data: [SourceTransaction], hasMore: Bool, object: GetSourcesSourceSourceTransactionsResponseObject, url: String) throws {
