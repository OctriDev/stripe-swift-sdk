...
// Canonical v1TaxTransactionsLineItems operation model declarations
public struct GetTaxTransactionsTransactionLineItemsResponse: Codable {
    ...
    /// `list`.
    public var object: GetTaxTransactionsTransactionLineItemsResponseObject
...
public extension GetTaxTransactionsTransactionLineItemsResponse {
...
public extension GetTaxTransactionsTransactionLineItemsResponse {
    public init(data: [TaxTransactionLineItem], hasMore: Bool, object: GetTaxTransactionsTransactionLineItemsResponseObject, url: String) throws {
