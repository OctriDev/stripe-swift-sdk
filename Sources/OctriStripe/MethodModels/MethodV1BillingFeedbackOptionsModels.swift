...
// Canonical v1BillingFeedbackOptions operation model declarations
/// Resource for the List Endpoint of Feedback Option.
public struct GetBillingFeedbackOptionsResponse: Codable {
    public var data: [BillingFeedbackOption]
    ...
    /// `list`.
    public var object: GetBillingFeedbackOptionsResponseObject
...
public extension GetBillingFeedbackOptionsResponse {
...
public extension GetBillingFeedbackOptionsResponse {
    public init(data: [BillingFeedbackOption], hasMore: Bool, object: GetBillingFeedbackOptionsResponseObject, url: String) throws {
