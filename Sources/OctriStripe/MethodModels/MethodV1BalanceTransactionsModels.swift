...
// Canonical v1BalanceTransactions operation model declarations
public struct GetBalanceTransactionsParameterVariant0: Codable {
    public var gt: Int?
    public var gte: Int?
    public var lt: Int?
    public var lte: Int?
...
public extension GetBalanceTransactionsParameterVariant0 {
...
public enum GetBalanceTransactionsParameter {
    case getBalanceTransactionsParameterVariant0(GetBalanceTransactionsParameterVariant0)
    case intValue(Int)
}

extension GetBalanceTransactionsParameter: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for GetBalanceTransactionsParameter")
    }

    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        if let value = try? container.decode(
            GetBalanceTransactionsParameterVariant0.self
        ) {
            return             .getBalanceTransactionsParameterVariant0(value)
        }
    ...
    private func encodeGroup1(to encoder: Encoder) throws -> Bool {
        ...
        switch self {
        case let .getBalanceTransactionsParameterVariant0(value): try container.encode(value); return true
...
public struct GetBalanceTransactionsResponse: Codable {
    ...
    /// `list`.
    public var object: GetBalanceTransactionsResponseObject
...
public extension GetBalanceTransactionsResponse {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension GetBalanceTransactionsResponse {
    public init(data: [BalanceTransaction], hasMore: Bool, object: GetBalanceTransactionsResponseObject, url: String) throws {
