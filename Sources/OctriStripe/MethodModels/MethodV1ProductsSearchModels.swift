...
// Canonical v1ProductsSearch operation model declarations
public struct GetProductsSearchResponse: Codable {
    public var data: [Product]
    public var hasMore: Bool
    /// String representing the object's type. Objects of the same type share the same value.
    public var object: GetProductsSearchResponseObject
...
public extension GetProductsSearchResponse {
...
public extension GetProductsSearchResponse {
    public init(data: [Product], hasMore: Bool, object: GetProductsSearchResponseObject, url: String, nextPage: String? = nil, totalCount: Int? = nil) throws {
