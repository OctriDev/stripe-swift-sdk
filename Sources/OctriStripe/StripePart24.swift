...
public class V1SigmaScheduledQueryRunsNamespace {
    ...
    public func getSigma(
        endingBefore: String?,
        expand: [String]?,
        limit: Int?,
        startingAfter: String?
    ) async throws -> GetSigmaScheduledQueryRunsResponse {
        try await V1SigmaScheduledQueryRunsMethods.getSigmaScheduledQueryRuns(
            config: config,
    ...
    public func getSigmaScheduledQueryRun(
        scheduledQueryRun: String,
        expand: [String]?
    ) async throws -> ScheduledQueryRun {
        try await V1SigmaScheduledQueryRunsMethods.getSigmaScheduledQueryRunsScheduledQueryRun(
            config: config,
...
public class V1SourcesMandateNotificationsNamespace {
    ...
    public func getSourcesSourceMandateNotification(
        mandateNotification: String,
        source: String,
        expand: [String]?
    ) async throws -> SourceMandateNotification {
        try await V1SourcesMandateNotificationsMethods.getSourcesSourceMandateNotificationsMandateNotification(
            config: config,
...
public class V1SourcesSourceTransactionsNamespace {
    ...
    public func getSourcesSource(
        ...
        try await V1SourcesSourceTransactionsMethods.getSourcesSourceSourceTransactions(
            config: config,
            source: source,
            endingBefore: endingBefore,
            expand: expand,
    ...
    public func getSourcesSourceSourceTransaction(
        source: String,
        sourceTransaction: String,
        expand: [String]?
    ) async throws -> SourceTransaction {
        try await V1SourcesSourceTransactionsMethods.getSourcesSourceSourceTransactionsSourceTransaction(
            config: config,
            source: source,
...
public class V1SourcesVerifyNamespace {
    ...
    public func postSourcesSource(source: String, values: [String], expand: [String]?) async throws -> Source {
        try await V1SourcesVerifyMethods.postSourcesSourceVerify(
            config: config,
            source: source,
            values: values,
            expand: expand
...
public class V1SourcesNamespace {
    ...
    public func post(options: V1SourcesMethods.PostSourcesOptions) async throws -> Source {
        try await V1SourcesMethods.postSources(config: config, options: options)
    }
    ...
    public func getSource(source: String, clientSecret: String?, expand: [String]?) async throws -> Source {
        try await V1SourcesMethods.getSourcesSource(
            config: config,
            source: source,
    ...
    public func postSource(
        ...
        try await V1SourcesMethods.postSourcesSource(
            config: config,
            source: source,
            amount: amount,
            expand: expand,
...
public class V1SubscriptionItemsNamespace {
    ...
    public func get(
        ...
        try await V1SubscriptionItemsMethods.getSubscriptionItems(
            config: config,
    ...
    public func post(options: V1SubscriptionItemsMethods
        .PostSubscriptionItemsOptions) async throws -> SubscriptionItem {
        try await V1SubscriptionItemsMethods.postSubscriptionItems(config: config, options: options)
    }
    ...
    public func deleteItem(
        ...
        try await V1SubscriptionItemsMethods.deleteSubscriptionItemsItem(
            config: config,
            item: item,
    ...
    public func getItem(item: String, expand: [String]?) async throws -> SubscriptionItem {
        try await V1SubscriptionItemsMethods.getSubscriptionItemsItem(config: config, item: item, expand: expand)
    }
    ...
    public func postItem(options: V1SubscriptionItemsMethods
        .PostSubscriptionItemsItemOptions) async throws -> SubscriptionItem {
        try await V1SubscriptionItemsMethods.postSubscriptionItemsItem(config: config, options: options)
    }
}
...
public class V1SubscriptionSchedulesCancelNamespace {
    ...
    public func postSubscriptionSchedulesSchedule(
        schedule: String,
        expand: [String]?,
        invoiceNow: Bool?,
        prorate: Bool?
    ) async throws -> SubscriptionSchedule {
        try await V1SubscriptionSchedulesCancelMethods.postSubscriptionSchedulesScheduleCancel(
            config: config,
            schedule: schedule,
            expand: expand,
...
public class V1SubscriptionSchedulesReleaseNamespace {
    ...
    public func postSubscriptionSchedulesSchedule(
        ...
        try await V1SubscriptionSchedulesReleaseMethods.postSubscriptionSchedulesScheduleRelease(
            config: config,
            schedule: schedule,
            expand: expand,
