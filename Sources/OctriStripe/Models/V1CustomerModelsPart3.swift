...
extension CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures {
...
extension CustomerSessionResourceComponentsResourcePricingTable {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
