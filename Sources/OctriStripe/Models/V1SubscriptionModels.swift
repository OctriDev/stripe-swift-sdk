...
extension SubscriptionBillingThresholds {
...
extension SubscriptionItemBillingThresholds {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension SubscriptionPaymentMethodOptionsBillie {
    public init() {
    }
}
...
extension SubscriptionPaymentMethodOptionsCard {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension SubscriptionPaymentMethodOptionsMandateOptionsPix {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension SubscriptionPaymentMethodOptionsPix {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension SubscriptionPendingInvoiceItemInterval {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension SubscriptionScheduleAddInvoiceItemPeriod {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension SubscriptionScheduleCurrentPhase {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.type) else {
            throw SdkValidationError(field: "type", code: "required", message: "Validation failed for 'type': value is required")
