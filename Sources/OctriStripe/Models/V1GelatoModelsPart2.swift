...
extension GelatoEmailReportError {
    public init(from decoder: Decoder) throws {
...
extension GelatoIdNumberReport {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension GelatoIdNumberReportError {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.sdkDecodeIfPresent(.code)
        self.reason = try container.sdkDecodeIfPresent(.reason)
...
extension GelatoPhoneReportError {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.sdkDecodeIfPresent(.code)
        self.reason = try container.sdkDecodeIfPresent(.reason)
...
extension GelatoProvidedDetails {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension GelatoReportDocumentOptions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension GelatoReportIdNumberOptions {
    public init() {
    }
}
