...
extension TerminalConfigurationConfigurationResourceCellularConfig {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TerminalConfigurationConfigurationResourceCurrencySpecificConfig {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TerminalConfigurationConfigurationResourceEnterprisePeapWifi {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TerminalConfigurationConfigurationResourceEnterpriseTlsWifi {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TerminalConfigurationConfigurationResourceOfflineConfig {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TerminalConfigurationConfigurationResourcePersonalPskWifi {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.password) else {
            throw SdkValidationError(field: "password", code: "required", message: "Validation failed for 'password': value is required")
...
extension TerminalConfigurationConfigurationResourceRebootWindow {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
