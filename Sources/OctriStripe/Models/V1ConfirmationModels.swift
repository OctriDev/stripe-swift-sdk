...
extension ConfirmationTokensResourceMandateData {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension ConfirmationTokensResourceMandateDataResourceCustomerAcceptance {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension ConfirmationTokensResourceMandateDataResourceCustomerAcceptanXcaec7acb33 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension ConfirmationTokensResourcePaymentMethodOptions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension ConfirmationTokensResourcePaymentMethodOptionsResourceCard {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension ConfirmationTokensResourcePaymentMethodOptionsResourceCardResX9a2a09f92c {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
