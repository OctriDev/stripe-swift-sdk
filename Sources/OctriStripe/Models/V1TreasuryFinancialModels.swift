...
extension TreasuryFinancialAccount {
...
extension TreasuryFinancialAccountFeatures {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TreasuryFinancialAccountsResourceAbaRecord {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TreasuryFinancialAccountsResourceAbaToggleSettings {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TreasuryFinancialAccountsResourceBalance {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TreasuryFinancialAccountsResourceClosedStatusDetails {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TreasuryFinancialAccountsResourceFinancialAddress {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension TreasuryFinancialAccountsResourceFinancialAddressesFeatures {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.aba = try container.sdkDecodeIfPresent(.aba)
    }
