...
public indirect enum TreasuryOutboundPaymentTransaction {
...
extension TreasuryOutboundPaymentsResourceReturnedStatus {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public indirect enum TreasuryOutboundPaymentsResourceReturnedStatusTransaction {
    case stringValue(String)
    case treasuryTransaction(TreasuryTransaction)
}
...
extension TreasuryOutboundTransfer {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.amount = try container.sdkDecodeRequired(.amount)
        self.cancelable = try container.sdkDecodeRequired(.cancelable)
