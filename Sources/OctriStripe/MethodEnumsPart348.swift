...
extension PostTestHelpersIssuingAuthorizationsRequestBodyMerchantDataCategory {
    static let allCasesPart1: [PostTestHelpersIssuingAuthorizationsRequestBodyMerchantDataCategory] = [
...
extension PostTestHelpersIssuingAuthorizationsRequestBodyMerchantDataCategory {
    static let allCasesPart2: [PostTestHelpersIssuingAuthorizationsRequestBodyMerchantDataCategory] = [
