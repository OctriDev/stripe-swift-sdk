...
extension PostIssuingCardholdersRequestBodySpendingControlsBlockedCategoriesItem {
    static let allCasesPart1: [PostIssuingCardholdersRequestBodySpendingControlsBlockedCategoriesItem] = [
...
extension PostIssuingCardholdersRequestBodySpendingControlsBlockedCategoriesItem {
    static let allCasesPart2: [PostIssuingCardholdersRequestBodySpendingControlsBlockedCategoriesItem] = [
