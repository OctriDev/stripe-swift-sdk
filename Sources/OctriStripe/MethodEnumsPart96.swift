...
extension PostIssuingCardholdersRequestBodySpendingControlsAllowedCategoriesItem {
    static let allCasesPart1: [PostIssuingCardholdersRequestBodySpendingControlsAllowedCategoriesItem] = [
...
extension PostIssuingCardholdersRequestBodySpendingControlsAllowedCategoriesItem {
    static let allCasesPart2: [PostIssuingCardholdersRequestBodySpendingControlsAllowedCategoriesItem] = [
