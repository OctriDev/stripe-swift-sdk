...
extension PostIssuingCardsRequestBodySpendingControlsAllowedCategoriesItem {
    static let allCasesPart2: [PostIssuingCardsRequestBodySpendingControlsAllowedCategoriesItem] = [
...
extension PostIssuingCardsRequestBodySpendingControlsAllowedCategoriesItem {
    static let allCasesPart3: [PostIssuingCardsRequestBodySpendingControlsAllowedCategoriesItem] = [
