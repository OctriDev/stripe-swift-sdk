...
public class V1AccountNamespace {
    ...
    public func get(expand: [String]?) async throws -> Account {
        try await V1AccountMethods.getAccount(config: config, expand: expand)
    }
}
...
public class V1AccountLinksNamespace {
    ...
    public func post(
        ...
        try await V1AccountLinksMethods.postAccountLinks(
            config: config,
            account: account,
            type: type,
            collect: collect,
...
public class V1AccountSessionsNamespace {
    ...
    public func post(
        ...
        try await V1AccountSessionsMethods.postAccountSessions(
            config: config,
            account: account,
...
public class V1AccountsBankAccountsNamespace {
    ...
    public func postAccountsAccount(
        ...
        try await V1AccountsBankAccountsMethods.postAccountsAccountBankAccounts(
            config: config,
            account: account,
    ...
    public func deleteAccountsAccountId(account: String, id: String) async throws -> DeletedExternalAccount {
        try await V1AccountsBankAccountsMethods.deleteAccountsAccountBankAccountsId(
            config: config,
            account: account,
            id: id
        )
    ...
    public func getAccountsAccountId(account: String, id: String, expand: [String]?) async throws -> ExternalAccount {
        try await V1AccountsBankAccountsMethods.getAccountsAccountBankAccountsId(
            config: config,
            account: account,
            id: id,
            expand: expand
    ...
    public func postAccountsAccountId(options: V1AccountsBankAccountsMethods
        .PostAccountsAccountBankAccountsIdOptions) async throws -> ExternalAccount {
        try await V1AccountsBankAccountsMethods.postAccountsAccountBankAccountsId(config: config, options: options)
    }
}
...
public class V1AccountsCapabilitiesNamespace {
    ...
    /// Lists the capabilities associated with an account. Results are sorted by creation date, with the most recently
    /// created capability first. Use `expand` when you need selected response fields expanded.
    ///
    /// Returns a list of capabilities associated with the account. The capabilities are returned sorted by creation
    /// date, with the most recent capability appearing first.
    public func getAccountsAccount(
        account: String,
        expand: [String]?
    ) async throws -> GetAccountsAccountCapabilitiesResponse {
        try await V1AccountsCapabilitiesMethods.getAccountsAccountCapabilities(
            config: config,
            account: account,
            expand: expand
        )
    ...
    /// Retrieves information about a specific capability associated with an account. Provide the account and capability
    /// identifiers to inspect its request state, status, requirements, and future requirements. Use `expand` to include
    /// selected response fields inline.
    ///
    /// Retrieves information about the specified Account Capability.
    public func getAccountsAccountCapability(
        account: String,
        capability: String,
        expand: [String]?
    ) async throws -> Capability {
        try await V1AccountsCapabilitiesMethods.getAccountsAccountCapabilitiesCapability(
            config: config,
            account: account,
    ...
    public func postAccountsAccountCapability(
        account: String,
        capability: String,
        expand: [String]?,
        requested: Bool?
    ) async throws -> Capability {
        try await V1AccountsCapabilitiesMethods.postAccountsAccountCapabilitiesCapability(
            config: config,
            account: account,
            capability: capability,
            expand: expand,
...
public class V1AccountsExternalAccountsNamespace {
    ...
    public func getAccountsAccount(
        ...
        try await V1AccountsExternalAccountsMethods.getAccountsAccountExternalAccounts(
            config: config,
            account: account,
    ...
    public func postAccountsAccount(
        ...
        try await V1AccountsExternalAccountsMethods.postAccountsAccountExternalAccounts(
            config: config,
            account: account,
            bankAccount: bankAccount,
            defaultForCurrency: defaultForCurrency,
    ...
    /// Delete a specified external account for a given account.
    public func deleteAccountsAccountId(account: String, id: String) async throws -> DeletedExternalAccount {
        try await V1AccountsExternalAccountsMethods.deleteAccountsAccountExternalAccountsId(
            config: config,
            account: account,
            id: id
        )
    ...
    /// Retrieve a specified external account for a given account.
    public func getAccountsAccountId(account: String, id: String, expand: [String]?) async throws -> ExternalAccount {
        try await V1AccountsExternalAccountsMethods.getAccountsAccountExternalAccountsId(
            config: config,
            account: account,
            id: id,
            expand: expand
    ...
    /// includes Custom accounts. You can re-enable a disabled bank account by performing an update call without
    /// providing any arguments or changes.
    public func postAccountsAccountId(options: V1AccountsExternalAccountsMethods
        .PostAccountsAccountExternalAccountsIdOptions) async throws -> ExternalAccount {
        try await V1AccountsExternalAccountsMethods.postAccountsAccountExternalAccountsId(
            config: config,
            options: options
        )
    }
...
public class V1AccountsLoginLinksNamespace {
    ...
    public func postAccountsAccount(account: String, expand: [String]?) async throws -> LoginLink {
        try await V1AccountsLoginLinksMethods.postAccountsAccountLoginLinks(
            config: config,
            account: account,
            expand: expand
        )
...
public class V1AccountsPeopleNamespace {
    ...
    public func getAccountsAccount(
        ...
        try await V1AccountsPeopleMethods.getAccountsAccountPeople(
            config: config,
            account: account,
            endingBefore: endingBefore,
            expand: expand,
    ...
    public func postAccountsAccount(options: V1AccountsPeopleMethods
        .PostAccountsAccountPeopleOptions) async throws -> Person {
        try await V1AccountsPeopleMethods.postAccountsAccountPeople(config: config, options: options)
    }
    ...
    public func deleteAccountsAccountPerson(account: String, person: String) async throws -> DeletedPerson {
        try await V1AccountsPeopleMethods.deleteAccountsAccountPeoplePerson(
            config: config,
            account: account,
            person: person
        )
    ...
    public func getAccountsAccountPerson(account: String, person: String, expand: [String]?) async throws -> Person {
        try await V1AccountsPeopleMethods.getAccountsAccountPeoplePerson(
            config: config,
            account: account,
            person: person,
            expand: expand
    ...
    public func postAccountsAccountPerson(options: V1AccountsPeopleMethods
        .PostAccountsAccountPeoplePersonOptions) async throws -> Person {
        try await V1AccountsPeopleMethods.postAccountsAccountPeoplePerson(config: config, options: options)
    }
}
