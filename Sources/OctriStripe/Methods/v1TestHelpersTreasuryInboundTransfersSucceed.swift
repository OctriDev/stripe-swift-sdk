...
public enum V1TestHelpersTreasuryInboundTransfersSucceedMethods {
    ...
    public static func postTestHelpersTreasuryInboundTransfersIdSucceed(
        config: ClientConfig,
        id: String,
        expand: [String]?
        ...
        return try await (sdkRequest(
            "POST",
            ["/v1/test_helpers/treasury/inbound_transfers/", sdkEncodePathSegment(sdkWireString(id)), "/succeed"]
                .joined(),
            config: config,
            body: requestBody,
