...
public enum V1TestHelpersTreasuryOutboundPaymentsMethods {
    ...
    public static func postTestHelpersTreasuryOutboundPaymentsId(
        config: ClientConfig,
        id: String,
        ...
        let requestBody = PostTestHelpersTreasuryOutboundPaymentsIdRequestBody(
        ...
        return try await (sdkRequest(
            "POST",
            ["/v1/test_helpers/treasury/outbound_payments/", sdkEncodePathSegment(sdkWireString(id))].joined(),
            config: config,
            body: requestBody,
