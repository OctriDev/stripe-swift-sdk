...
extension V1TreasuryOutboundTransfersMethods {
    ...
    public static func getTreasuryOutboundTransfers(config: ClientConfig, financialAccount: String, endingBefore: String?, expand: [String]?, limit: Int?, startingAfter: String?, status: GetTreasuryOutboundTransfersParameter?) async throws -> GetTreasuryOutboundTransfersResponse {
