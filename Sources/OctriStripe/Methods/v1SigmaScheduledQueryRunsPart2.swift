...
#endif
extension V1SigmaScheduledQueryRunsMethods {
    ...
    ///   the list.
    public static func getSigmaScheduledQueryRuns(config: ClientConfig, endingBefore: String?, expand: [String]?, limit: Int?, startingAfter: String?) async throws -> GetSigmaScheduledQueryRunsResponse {
