...
public enum V1PaymentMethodDomainsValidateMethods {
    ...
    public static func postPaymentMethodDomainsPaymentMethodDomainValidate(
        config: ClientConfig,
        ...
        return try await (sdkRequest(
            "POST",
            ["/v1/payment_method_domains/", sdkEncodePathSegment(sdkWireString(paymentMethodDomain)), "/validate"]
                .joined(),
            config: config,
            body: requestBody,
