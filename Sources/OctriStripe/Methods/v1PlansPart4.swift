...
public extension V1PlansMethods {
    ...
    static func deletePlansPlan(config: ClientConfig, plan: String) async throws -> DeletedPlan {
    ...
    static func getPlansPlan(config: ClientConfig, plan: String, expand: [String]?) async throws -> Plan {
        try validateLength("plan", plan, max: 5000)
