...
extension V1WebhookEndpointsMethods {
    ...
    ///   the list.
    public static func getWebhookEndpoints(config: ClientConfig, endingBefore: String?, expand: [String]?, limit: Int?, startingAfter: String?) async throws -> GetWebhookEndpointsResponse {
