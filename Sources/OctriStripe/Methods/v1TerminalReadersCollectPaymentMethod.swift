...
public enum V1TerminalReadersCollectPaymentMethodMethods {
    ...
    public static func postTerminalReadersReaderCollectPaymentMethod(
        config: ClientConfig,
        reader: String,
        ...
        let requestBody = PostTerminalReadersReaderCollectPaymentMethodRequestBody(
        ...
        return try await (sdkRequest(
            "POST",
            ["/v1/terminal/readers/", sdkEncodePathSegment(sdkWireString(reader)), "/collect_payment_method"].joined(),
            config: config,
            body: requestBody,
