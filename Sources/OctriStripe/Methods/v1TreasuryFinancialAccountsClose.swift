...
public enum V1TreasuryFinancialAccountsCloseMethods {
    ...
    public static func postTreasuryFinancialAccountsFinancialAccountClose(
        config: ClientConfig,
        ...
        let requestBody = PostTreasuryFinancialAccountsFinancialAccountCloseRequestBody(
            expand: expand,
        ...
        return try await (sdkRequest(
            "POST",
            ["/v1/treasury/financial_accounts/", sdkEncodePathSegment(sdkWireString(financialAccount)), "/close"]
                .joined(),
            config: config,
            body: requestBody,
