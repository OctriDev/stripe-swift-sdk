...
public enum V1TestHelpersIssuingCardsShippingShipMethods {
    ...
    public static func postTestHelpersIssuingCardsCardShippingShip(
        config: ClientConfig,
        card: String,
        expand: [String]?
        ...
        return try await (sdkRequest(
            "POST",
            ["/v1/test_helpers/issuing/cards/", sdkEncodePathSegment(sdkWireString(card)), "/shipping/ship"].joined(),
            config: config,
            body: requestBody,
