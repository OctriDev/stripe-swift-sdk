...
public enum V1TestHelpersTreasuryInboundTransfersReturnMethods {
    ...
    public static func postTestHelpersTreasuryInboundTransfersIdReturn(
        config: ClientConfig,
        id: String,
        expand: [String]?
        ...
        return try await (sdkRequest(
            "POST",
            ["/v1/test_helpers/treasury/inbound_transfers/", sdkEncodePathSegment(sdkWireString(id)), "/return"]
                .joined(),
            config: config,
            body: requestBody,
