...
extension V1CountrySpecsMethods {
    ...
    ///   the list.
    public static func getCountrySpecs(config: ClientConfig, endingBefore: String?, expand: [String]?, limit: Int?, startingAfter: String?) async throws -> GetCountrySpecsResponse {
