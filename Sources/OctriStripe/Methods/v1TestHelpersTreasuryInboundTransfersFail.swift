...
public enum V1TestHelpersTreasuryInboundTransfersFailMethods {
    ...
    public static func postTestHelpersTreasuryInboundTransfersIdFail(
        config: ClientConfig,
        id: String,
        expand: [String]?,
        ...
        let requestBody = PostTestHelpersTreasuryInboundTransfersIdFailRequestBody(
            expand: expand,
        ...
        return try await (sdkRequest(
            "POST",
            ["/v1/test_helpers/treasury/inbound_transfers/", sdkEncodePathSegment(sdkWireString(id)), "/fail"].joined(),
            config: config,
            body: requestBody,
