...
public enum V1TestHelpersIssuingCardsShippingReturnMethods {
    ...
    public static func postTestHelpersIssuingCardsCardShippingReturn(
        config: ClientConfig,
        card: String,
        expand: [String]?
        ...
        return try await (sdkRequest(
            "POST",
            ["/v1/test_helpers/issuing/cards/", sdkEncodePathSegment(sdkWireString(card)), "/shipping/return"].joined(),
            config: config,
            body: requestBody,
