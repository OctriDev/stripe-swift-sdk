...
extension PostIssuingCardsRequestBodySpendingControlsBlockedCategoriesItem {
    static let allCasesPart2: [PostIssuingCardsRequestBodySpendingControlsBlockedCategoriesItem] = [
...
extension PostIssuingCardsRequestBodySpendingControlsBlockedCategoriesItem {
    static let allCasesPart3: [PostIssuingCardsRequestBodySpendingControlsBlockedCategoriesItem] = [
