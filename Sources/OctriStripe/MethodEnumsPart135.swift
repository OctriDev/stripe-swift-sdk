...
extension PostIssuingCardsCardRequestBodySpendingControlsAllowedCategoriesItem {
    static let allCasesPart2: [PostIssuingCardsCardRequestBodySpendingControlsAllowedCategoriesItem] = [
...
extension PostIssuingCardsCardRequestBodySpendingControlsAllowedCategoriesItem {
    static let allCasesPart3: [PostIssuingCardsCardRequestBodySpendingControlsAllowedCategoriesItem] = [
