...
extension PostIssuingCardsCardRequestBodySpendingControlsBlockedCategoriesItem {
    static let allCasesPart2: [PostIssuingCardsCardRequestBodySpendingControlsBlockedCategoriesItem] = [
...
extension PostIssuingCardsCardRequestBodySpendingControlsBlockedCategoriesItem {
    static let allCasesPart3: [PostIssuingCardsCardRequestBodySpendingControlsBlockedCategoriesItem] = [
